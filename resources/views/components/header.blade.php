...
<header class="header-style-five">
            ...
            <div class="col-12">
                <div class="row justify-content-lg-between justify-content-center">
                    ...
                    <div class="col-auto header-top-left order-2 order-lg-1">
                        <ul>
                            <li>
                                <a href="tel:0123456789"><i class="fa fa-phone"></i>0812-2253-5789</a>
                            </li>
                            <li>
                                <a href="mailto:demo@example.com"><i class="fa fa-envelope-open-o"></i>
                                    demo@kosmetik.com</a>
                            </li>
                            <li>
    ...
    <nav>
        <ul class="header-bottom-list d-flex justify-content-center">
            ...
            <li class="{{ request()->routeIs('pr') ? 'active' : '' }}">
                <a href="{{ route('pr') }}">Produk</a>
            </li>
            <li class="{{ request()->routeIs('kontak-kami') ? 'active' : '' }}">
            ...
            <li class="{{ request()->is('galeri') ? 'active' : '' }}">
                ...
                <div class="mobile-menu d-block d-lg-none mt-1">
                    <nav>
                        <ul>
