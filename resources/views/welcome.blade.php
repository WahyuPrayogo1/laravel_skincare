...
<!-- Mirrored from htmldemo.net/makali/makali/index-cosmetic-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Aug 2025 02:35:13 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="row justify-content-lg-between justify-content-center">
                            ...
                            <div class="col-auto header-top-right order-1 order-lg-2">
                                <ul>
                                    <li>
                                        <a href="#">
                                            <img src="{{asset('frontend/img/header/1.webp')}}" alt="language-selector">English
                                        ...
                                        <ul class="ht-dropdown">
                                            <li>
                                                <a href="#">
                                                    <img src="{{asset('frontend/img/header/1.webp')}}" alt="language-selector">English</a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <img src="{{asset('frontend/img/header/2.webp')}}" alt="language-selector">Francis</a>
                                            </li>
                                        </ul>
                                        <!-- Dropdown End -->
                                    </li>
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-7 col-lg-8 d-none d-lg-block position-static">
                                 <nav>
                                    <ul class="header-bottom-list d-flex justify-content-center">
                                        <li class="active position-static">
                                            <a href="index-cosmetic.html">Home</a>

                                        </li>
                                        <li>
                                            <a href="shop.html">Tentang Kami</a>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="slider-content">
                                    <h1>New Artist Eye Shadow</h1>
                                    <h2>Palette 2022</h2>
                                    <p>Discover our 5 new limited-edition highlighter shades inspired by the luster and
                                        brilliance of pearls found in the depths of the ocean.</p>
                ...
                <div class="slide align-center-left fullscreen animation-style-02 bg-image-10">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="slider-content">
                                    <h1>Collagen Renewal For</h1>
                                    <h2>Ageless Skin</h2>
                                    <p>Anti-Agring Wrinkle Cream With SYN-Coll, Clinically Proven to Reduce Wrinkles by
                                        up to 354%. Skin Looks Thicker, Firmers.</p>
                                    <div class="slide-btn white-color">
                                        <a href="shop.html">Shop Now</a>
                                    </div>
                                </div>
        ...
        <div class="categories-of-pro pt-20">
            <div class="container-fluid">
                ...
                <div class="categorie-pro-active owl-carousel">
                    <!-- Single Cat Pro Start -->
                    <div class="single-categorie">
                        <div class="cat-img">
                            <a href="#">
                                <img src="{{asset('frontend/img/categoires-pro/c5.webp')}}" alt="cat-pro">
                            </a>
                    ...
                    <div class="single-categorie">
                        <div class="cat-img">
                            <a href="#">
                                <img src="{{asset('frontend/img/categoires-pro/c1.webp')}}" alt="cat-pro">
                            </a>
                            <div class="cat-content">
                                <a href="#">Necklaces</a>
                            </div>
                    ...
                    <div class="single-categorie">
                        <div class="cat-img">
                            <a href="#">
                                <img src="{{asset('frontend/img/categoires-pro/c2.webp')}}" alt="cat-pro">
                            </a>
                            <div class="cat-content">
                                <a href="#">Bracelets</a>
                            </div>
                    ...
                    <div class="single-categorie">
                        <div class="cat-img">
                            <a href="#">
                                <img src="{{asset('frontend/img/categoires-pro/c3.webp')}}" alt="cat-pro">
                            </a>
                            <div class="cat-content">
                                <a href="#">Portfolio</a>
                            </div>
                    ...
                    <div class="single-categorie">
                        <div class="cat-img">
                            <a href="#">
                                <img src="{{asset('frontend/img/categoires-pro/c4.webp')}}" alt="cat-pro">
                            </a>
                            <div class="cat-content">
                                <a href="#">Necklaces</a>
                            </div>
            ...
            <div class="container">
                ...
                <div class="our-pro-active owl-carousel">
                    ...
                    <div class="single-makal-product">
                        <div class="pro-img">
                            <a href="product-details.html">
                                <img src="{{asset('frontend/img/products/cosmetic/1.webp')}}" alt="product-img">
                            </a>
                    ...
                    <div class="single-makal-product">
                        <div class="pro-img">
                            <a href="product-details.html">
                                <img src="{{asset('frontend/img/products/cosmetic/4.webp')}}" alt="product-img">
                            </a>
                            <span class="sticker-new">new</span>
                    ...
                    <div class="single-makal-product">
                        <div class="pro-img">
                            <a href="product-details.html">
                                <img src="{{asset('frontend/img/products/cosmetic/6.webp')}}" alt="product-img">
                            </a>
                            <span class="sticker-new">new</span>
                            <span class="sticker-sale">-5%</span>
                            <div class="quick-view-pro">
                    ...
                    <div class="single-makal-product">
                        <div class="pro-img">
                            <a href="product-details.html">
                                <img src="{{asset('frontend/img/products/cosmetic/10.webp')}}" alt="product-img">
                            </a>
                            <span class="sticker-new">new</span>
                            <span class="sticker-sale">-5%</span>
                            <div class="quick-view-pro">
                    ...
                    <div class="single-makal-product">
                        <div class="pro-img">
                            <a href="product-details.html">
                                <img src="{{asset('frontend/img/products/cosmetic/11.webp')}}" alt="product-img">
                            </a>
                            <span class="sticker-new">new</span>
                            <span class="sticker-sale">-5%</span>
                            <div class="quick-view-pro">
                    ...
                    <div class="single-makal-product">
                        <div class="pro-img">
                            <a href="product-details.html">
                                <img src="{{asset('frontend/img/products/cosmetic/9.webp')}}" alt="product-img">
                            </a>
                            <span class="sticker-new">new</span>
                            <span class="sticker-sale">-5%</span>
                            <div class="quick-view-pro">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6 mb-xsm-30">
                        <div class="single-banner zoom">
                            <a href="#">
                                <img src="{{asset('frontend/img/banner/cosmetic/3-1.webp')}}" alt="banner-img">
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="banner-inner-top">
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-6">
                                    <div class="single-banner zoom">
                                        <a href="#">
                                            <img src="{{asset('frontend/img/banner/cosmetic/3-2.webp')}}" alt="banner-img">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 col-6">
                                    <div class="single-banner zoom">
                                        <a href="#">
                                            <img src="{{asset('frontend/img/banner/cosmetic/3-3.webp')}}" alt="banner-img">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="banner-inner-bottom single-banner zoom mt-30">
                            <a href="#">
                                <img src="{{asset('frontend/img/banner/cosmetic/3-4.webp')}}" alt="banner-img">
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="best-seller no-border-style ptb-90">
            <div class="container">
                ...
                <div class="section-title text-center">
                    ...
                    <p>Add our bestsellers to your weekly lineup </p>
                </div>
                <!-- Section Title End -->
                <div class="our-pro-active owl-carousel">
                    <!-- Single Product Start Here -->
                    <div class="single-makal-product">
                        <div class="pro-img">
                            <a href="product-details.html">
                                <img src="{{asset('frontend/img/products/cosmetic/12.webp')}}" alt="product-img">
                            </a>
                            <span class="sticker-new">new</span>
                            <div class="quick-view-pro">
                                <a data-bs-toggle="modal" data-bs-target="#product-window" class="quick-view" href="#"></a>
                    ...
                    <div class="single-makal-product">
                        <div class="pro-img">
                            <a href="product-details.html">
                                <img src="{{asset('frontend/ucts/cosmetic/3.webp')}}" alt="product-img">
                            </a>
                            <span class="sticker-new">new</span>
                            <span class="sticker-sale">-5%</span>
                            <div class="quick-view-pro">
            ...
            <div class="container">
                ...
                <div class="brand-logo-active owl-carousel">
                    <div class="single-brand">
                        <a href="#"><img src="{{asset('frontend/img/brand/b1.webp')}}" alt="brand-image"></a>
                    </div>
                    <div class="single-brand">
                        <a href="#"><img src="{{asset('frontend/img/brand/b2.webp')}}" alt="brand-image"></a>
                    </div>
                    <div class="single-brand">
                        <a href="#"><img src="{{asset('frontend/img/brand/b3.webp')}}" alt="brand-image"></a>
                    </div>
                    <div class="single-brand">
                        <a href="#"><img src="{{asset('frontend/img/brand/b5.webp')}}" alt="brand-image"></a>
                    </div>
                    <div class="single-brand">
                        <a href="#"><img src="{{asset('frontend/img/brand/b4.webp')}}" alt="brand-image"></a>
                    </div>
                    <div class="single-brand">
                        <a href="#"><img src="{{asset('frontend/img/brand/b1.webp')}}" alt="brand-image"></a>
                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-all-30">
                            <div class="single-footer">
                                <div class="footer-logo mb-20">
                                    <a href="#"><img class="img" src="img/logo/logo.webp" alt="logo-img"></a>
                                </div>
                                <div class="footer-content">
                                    <ul class="footer-list first-content">
                                        <li><i class="pe-7s-map-marker"></i>Your address goes here.
                                        </li>
                                         <li><i class="pe-7s-call"></i>0123456789</li>
                    ...
                    <div class="col-md-12">
                        <div class="row align-items-center justify-content-md-between">
                            <div class="col-auto footer-copyright ">
                                    <p>&copy; 2022
                                        <a href="javascript:void(0)">Makali</a>
                                        Made with <i class="fa fa-heart"></i> by <a target="_blank" href="https://www.hasthemes.com/">HasThemes</a>
                                    </p>
                                </div>
                            <div class="col-auto footer-payment">
                                <a href="#"><img src="img/payment/payment.webp" alt="payment-img" class="img"></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from htmldemo.net/makali/makali/index-cosmetic-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Aug 2025 02:35:14 GMT -->
</html>
